...
print('当k=1时，有 %d / %d 个正确的数据 => accuracy: %f' % (num_correct, num_test, accuracy))
...
num_correct = np.sum(y_test_pred == y_test)
accuracy = float(num_correct) / num_test
print('当k=5时，有 %d / %d 个正确的数据 => accuracy: %f' % (num_correct, num_test, accuracy))
